...
std::optional<TokenExpression*> Parser::tokenExpression() {
  ...
  return std::nullopt; /* it was a mistake */
  //throw "tokenExpression: syntax error";
}
...
std::optional<Expression*> Parser::bracketExpression() {
  ...
  return std::nullopt; /* it was wrong */
   // throw "bracketExpression: syntax error";
}
